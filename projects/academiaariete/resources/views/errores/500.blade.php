@extends('layouts.app')
@section('title', 'Error interno · Ariete')
...
<section class="panel-page min-h-[60vh] flex items-center justify-center">
  <div class="w-full max-w-3xl bg-white border border-slate-200 rounded-2xl shadow-xl px-6 py-8 md:px-10 md:py-10 text-center">
    ...
    {{-- Icono --}}
    <div class="mb-4">
      <span class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-100 text-red-600 text-3xl">
    ...
    <h1 class="titulo mb-3">
      Ha ocurrido un problema en la web
    </h1>

    <p class="text-sm md:text-base text-slate-600 max-w-xl mx-auto mb-6">
      Hemos tenido un error inesperado al procesar tu solicitud.
      Inténtalo de nuevo en unos instantes y, si el problema continúa,
      avísanos para que podamos revisarlo.
    </p>
    ...
    <p class="mt-6 text-[11px] text-slate-400">
      El equipo técnico de Ariete revisará el incidente lo antes posible.
    </p>
  </div>
</section>
@endsection
