...
@section('title', 'Crear promoción · Ariete')

@section('content')
<div class="min-h-[60vh] flex items-center justify-center">
    <div class="w-full max-w-3xl bg-white border border-slate-200 rounded-2xl shadow-xl px-6 py-6 md:px-8 md:py-8">
        <h1 class="titulo mb-2">Crear promoción</h1>
        <p class="text-sm text-slate-600 mb-4">
            Crea una promoción para destacar información en la página de inicio (ofertas, novedades, recordatorios, etc.).
        </p>
